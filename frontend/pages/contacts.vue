<template>
    <div class="bg-slate-100 h-screen w-screen">
        ...
        <div class="pt-14 px-10 w-screen">
            ...
            <input placeholder="Search contacts" class="mt-5 rounded p-1 shadow-x1 w-300">
        </div>
        <div class="my-16 lg:mx-20 lg:grid lg:grid-cols-3 lg:gap-y-4 lg:gap-x-5 xl:gap-x-16 xl:mx-40">
            <div v-for="(contact, index) in contactsStore.userContacts" :key="index" :class="{'bg-white': index % 2 == 0, 
